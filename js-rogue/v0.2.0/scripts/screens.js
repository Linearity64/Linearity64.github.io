...
Game.Screen.startScreen = {
	...
	render: function(display) {																	// Render function
        display.drawText(1,1, "%c{yellow}Javascript Roguelike with ROT.js");					// Print out text on screen
        display.drawText(1,2, "Press [Enter] to start");
		display.drawText(1,4, "Snapshot v0.2.0");
		display.drawText(1,5, "[5/11/21]");
		display.drawText(1,6, "By Linearity64");
		display.drawText(1,8, "Changelogs:");
		display.drawText(1,9, "- Implemented seperated map and display options");
		display.drawText(1,10, "- Implemented scrolling");
		display.drawText(1,11, "- Implemented player");
    },
